export default class Drawflow {
  ...
  updateConnection(eX, eY) {
    ...
    var line_x =
      ...
      this.line_path / 2 +
      this.ele_selected.parentElement.parentElement.offsetLeft +
      this.ele_selected.offsetLeft;
    var line_y =
      this.ele_selected.offsetHeight / 2 +
      this.line_path / 2 +
      this.ele_selected.parentElement.parentElement.offsetTop +
      this.ele_selected.offsetTop;
  ...
  updateConnectionNodes(id) {
    ...
    Object.keys(elemsOut).map(function (item, index) {
      ...
      var eX =
        ...
        line_path +
        elemtsearch.parentElement.parentElement.offsetLeft +
        elemtsearch.offsetLeft;
      var eY =
        elemtsearch.offsetHeight / 2 +
        line_path +
        elemtsearch.parentElement.parentElement.offsetTop +
        elemtsearch.offsetTop;

      var line_x =
        elemtsearchId_out.offsetLeft +
        elemtsearchId_out.querySelectorAll("." + elemsOut[item].classList[3])[0]
          .offsetLeft +
        elemtsearchId_out.querySelectorAll("." + elemsOut[item].classList[3])[0]
          .offsetWidth /
          2 +
    ...
    Object.keys(elems).map(function (item, index) {
      ...
      var x =
        elemtsearchId_in.offsetLeft +
        elemtsearchId_in.querySelectorAll("." + elems[item].classList[4])[0]
          .offsetLeft +
        elemtsearchId_in.querySelectorAll("." + elems[item].classList[4])[0]
          .offsetWidth /
          2 +
      ...
      var hx2 = x - Math.abs(x - line_x) * curvature;
      // console.log('M '+ line_x +' '+ line_y +' C '+ hx1 +' '+ line_y +' '+ hx2 +' ' + y +' ' + x +'  ' + y );
      elems[item].children[0].setAttributeNS(
        null,
        "d",
        "M " +
          line_x +
